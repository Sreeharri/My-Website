...
const projects = [
  {
    id: 1,
    title: 'Ai Saas',
    description: 'A SaaS application powered by AI',
    ...
    <section id='projects' className='py-24 relative'>
      <div className='container mx-auto max-w-5xl'>
        ...
        <div className='text-center mt-12'>
          <a className='cosmic-button w-fit flex items-center mx-auto gap-2' href='https://github.com/Sreeharri' target='_blank'> Check My Github < ArrowRight size={16}/> </a>
        </div>
      </div>
    </section>
  )
